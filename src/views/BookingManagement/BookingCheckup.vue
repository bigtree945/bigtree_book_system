        ...
        <el-card>
            <header>
                <div class="radio" @change="radioChange">
                    ...
                    <el-radio v-model="radio" label="待体检">待体检</el-radio>
            ...
            <el-table style="width: 100%" header-cell-class-name="header-row" cell-class-name="cell-row"
                :data="tableData.BookingCheckup" size="medium">
                ...
                <el-table-column prop="setMeal" label="套餐" width="160">
                </el-table-column>
                ...
                <el-table-column prop="date" label="体检日期" width="100">
                </el-table-column>
...
export default {
    ...
    methods: {
        async getData() {
            ...
            let res = await this.$api.getBookingCheckup({
...
.el-table {
    ...
    // 多选框选中效果
    /deep/.is-checked .el-checkbox__inner,/deep/.is-indeterminate .el-checkbox__inner{
        background-color: #006eff;
        border: 2.5px solid #006eff;
    }
